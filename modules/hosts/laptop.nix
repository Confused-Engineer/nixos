# laptop — unstable nixpkgs, home-manager, both binary caches,
# nixos-hardware profile for the Dell Latitude 5520.
{ config, inputs, ... }:
let
  nixos = config.flake.modules.nixos;
in
{
  flake.nixosConfigurations.laptop = inputs.nixpkgs-unstable.lib.nixosSystem {
    system = "x86_64-linux";
